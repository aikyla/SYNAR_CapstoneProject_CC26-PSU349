...
import { Home, Clock, Map as MapIcon, User, Menu, X } from 'lucide-react';
    ...
    <header className="fixed top-0 left-0 right-0 z-[1200] bg-white/70 backdrop-blur-xl border-b border-white/40 shadow-sm">
      <div className="max-w-5xl mx-auto px-4 md:px-6 h-16 flex items-center justify-between">
        <Link to="/app" className="flex items-center gap-2">
          <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-orange-400 to-yellow-400 flex items-center justify-center shadow-lg shadow-orange-500/20 overflow-hidden">
            <img src={iconPng} className="w-6 h-6 object-contain" alt="SYNAR Logo" />
          </div>
      ...
      <header className="fixed top-0 left-0 right-0 z-[1200] bg-white/50 backdrop-blur-xl border-b border-white/40">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-orange-400 to-yellow-400 flex items-center justify-center overflow-hidden">
              <img src={iconPng} className="w-5 h-5 object-contain" alt="SYNAR Logo" />
            </div>
